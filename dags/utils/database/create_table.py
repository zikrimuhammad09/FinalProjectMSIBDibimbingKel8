...
def create_table():
    ...
    try:
        ...
        # cursor.execute('CREATE TABLE IF NOT EXISTS zip_codes (zip VARCHAR(20) PRIMARY KEY, lat VARCHAR(100), lng VARCHAR(100), city VARCHAR(100),state_id VARCHAR(100), state_name VARCHAR(100))')
        ...
        # cursor.execute('ALTER TABLE customers ADD FOREIGN KEY (zip_code) REFERENCES zip_codes (zip)')
